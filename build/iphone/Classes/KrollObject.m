...
//@interface KapFlixObject : NSObject
//@end

@interface KapFlixObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[KapFlixObject class]])
		{
			for (NSString *key in [[(KapFlixObject*)o modules] allKeys])
			{
