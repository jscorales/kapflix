...
// in simulator we redefine to format for KapFlix Developer console
...
{\
	NSString * exceptionName = [@"org.kapflix." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.kapflix";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIKapFlixNativeItemNone = -1, 
	UIKapFlixNativeItemSpinner = -2,
	UIKapFlixNativeItemProgressBar = -3,
	
	UIKapFlixNativeItemSlider = -4,
	UIKapFlixNativeItemSwitch = -5,
	UIKapFlixNativeItemMultiButton = -6,
	UIKapFlixNativeItemSegmented = -7,
	
	UIKapFlixNativeItemTextView = -8,
	UIKapFlixNativeItemTextField = -9,
	UIKapFlixNativeItemSearchBar = -10,
	
	UIKapFlixNativeItemPicker = -11,
	UIKapFlixNativeItemDatePicker = -12,
	
	UIKapFlixNativeItemInfoLight = -13,
	UIKapFlixNativeItemInfoDark = -14,
	
	UIKapFlixNativeItemDisclosure = -15,
	
	UIKapFlixNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all KapFlix instances of
