...
/**
 The base class for all KapFlix modules
 */
...
/**
 KapFlix Platform calls this method on startup.
 */
-(void)startup;

/**
 KapFlix Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 KapFlix Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 KapFlix Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 KapFlix Platform calls this method on resume.
 @param sender The sender of the event.
 */
